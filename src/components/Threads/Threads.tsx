...
/** Animated thread lines (React Bits registry: Threads-JS-CSS). Upstream omitted the JSX return. */
export function Threads({
  ...
  return (
    <div
      ref={containerRef}
      className={[styles.threadsContainer, className].filter(Boolean).join(" ")}
      {...rest}
    />
  );
}
